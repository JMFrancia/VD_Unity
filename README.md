...
**[Play the WebGL build](BUILD_LINK)** | **[Watch the gameplay video](https://www.youtube.com/watch?v=b_66koJZNz8)** | **[Read the AI session log](docs/ai-transcript/README.md)**

> Replace `BUILD_LINK` above with the Unity Play URL before submission. The gameplay video and AI session log links already resolve.
